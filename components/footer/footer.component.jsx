      ...
      <Content>
        <Row>
          <Col xs={12} md={8}>
            ...
            © 2014 - {date.getFullYear()} «Выездной ремонт Apple в Красноярске».
            Все права защищены.
            <br />
          ...
          <ColSN xs={12} md={4}>
            ...
            <Contacts>
              ...
              >
                <img src='/icons/vk.svg' height={24} alt='VK' />
              </a>
              <a
              ...
              >
                <img src='/icons/telegram.svg' height={24} alt='Telegram' />
              </a>
              <a
              ...
              >
                <img src='/icons/instagram.svg' height={24} alt='Instagram' />
              </a>
              <a
                href='https://wa.me/+79082122240?text=Привет!%20Я%20хочу%20уточнить...'
                onClick={() => {
                  ReactGA.event({
                    category: 'Соц. Сети',
                    action: 'WhatsApp',
              ...
              >
                <img src='/icons/whatsapp.svg' height={24} alt='WhatsApp' />
              </a>
            </Contacts>
          </ColSN>
        </Row>
